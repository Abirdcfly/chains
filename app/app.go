...
import (
	...
	chainsmodule "github.com/Abirdcfly/chains/x/chains"
	chainsmodulekeeper "github.com/Abirdcfly/chains/x/chains/keeper"
	chainsmoduletypes "github.com/Abirdcfly/chains/x/chains/types"
...
func New(
	...
	*/
	...
	app.ChainsKeeper = *chainsmodulekeeper.NewKeeper(
		appCodec,
		keys[chainsmoduletypes.StoreKey],
		keys[chainsmoduletypes.MemStoreKey],
		app.GetSubspace(chainsmoduletypes.ModuleName),
	)
	chainsModule := chainsmodule.NewAppModule(appCodec, app.ChainsKeeper, app.AccountKeeper, app.BankKeeper)
